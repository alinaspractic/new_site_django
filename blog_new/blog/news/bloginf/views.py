...
from bloginf.forms import AddPostForm, LoginUserForm, RegisterUserForm
...
class AddPage(LoginRequiredMixin, DataMixin, CreateView):
    ...
    template_name = 'bloginf/addpage.html'
...
class ShowPost(DataMixin, DetailView):
    model = Post
    template_name = 'bloginf/post.html'
...
class BlogHome(DataMixin, ListView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        context = super().get_context_data(**kwargs)
        context['menu'] = menu
        context['title'] = 'Главная страница.Книжный клуб'
...
def about(request):  # HttpReguest
    return render(request, 'bloginf/about.html', {'menu': menu, 'title': 'Книжный клуб'})
